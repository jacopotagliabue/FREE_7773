...
and a final step creating a Sagemaker endpoint for live predictions. This script has been created 
for pedagogical purposes, and it does NOT necessarely reflect all best practices.

Please refer to the slides and our discussion for further context.

MAKE SURE TO RUN THIS WITH METAFLOW S3 DATASTORE, so that we can upload the artifact to S3
...
class SampleRegressionFlowDeploy(FlowSpec):
    ...
    def test_model(self):
        ...
        self.next(self.deploy_model_to_sagemaker)
